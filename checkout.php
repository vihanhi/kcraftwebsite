...
<header class="header">
  ...
  <div class="container">
    ...
    <div class="admin-form">
        <form id="workshopForm" action="Handler/usercheckouthandler.php" method="POST">
            <label for="title">Product Name</label>
            <input type="text" id="title" value="<?php echo ($Productname); ?>">

            <input type="text" class="form-control" id="productId" placeholder="Product Id" name="productId" value="<?php echo($productId); ?> " hidden>
