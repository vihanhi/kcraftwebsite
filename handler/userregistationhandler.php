...
if (mysqli_num_rows($RESULT_USER_REGISTATION)>0) {
    ...
    echo "<script> alert('This Phone Number Already Use')window.setTimeout(function(){window.location.href='../index.php');</script>";
    ...
    if (mysqli_query($conn, $SQL_USER_REGISTATION)){
      ...
      echo "<script> alert('Account Created Successfuly. Login Please!'); window.setTimeout(function(){ window.location.href = '../login.php';},);</script>";
